class Auto:
    def __init__(self, brand: str, model: str| None = None, year: int | None = None,
...
car_one = Auto(brand="БМВ", model="M5", year=2015, fuel_type="Дизель")
car_two = Auto("Volkswagen", "Golf")
car_three = Auto("Volvo", "FH")
car_four = Auto("Harley Davidson")
